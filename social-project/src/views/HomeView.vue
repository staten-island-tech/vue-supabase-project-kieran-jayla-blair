...
<div class='container'>
  <div class='window'>
    ...
    <div class='content'>
      ...
      <button><RouterLink style="text-decoration: none; color: inherit;" to="/signIn">Already have an account? Sign In</RouterLink></button>
...
.overlay {
  background: -webkit-linear-gradient(#a0c0ff, #ffc6d4);
  background: linear-gradient(#a0c0ff, #ffc6d4);
  opacity: 0.85;
